...
function videoSys(cfg, sceneCount) {
  ...
  return [
    ...
    `- "Voice: ${cfg.voice_description}."`,
    `- "Video style: vertical 9:16, ~8 seconds, semi-realistic cartoon realism, cinematic natural sunlight, subtle motion. No subtitles, no captions, no text overlays, no music, no singing, no morphing."`,
    ``,
    `Правила вывода:`,
